...
export type Principal =
  ...
  | { readonly kind: 'key'; readonly keyId: string; readonly projectId: string; readonly scope: Scope }
...
export const getMembership = (projectId: string, userId: string) =>
  query((db) => db.member.findUnique({ where: { projectId_userId: { projectId, userId } } }))

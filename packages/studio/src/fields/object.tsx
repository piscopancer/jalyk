...
// Редактор вложенного объекта: рекурсивно рисует подполя по карте field.fields.
// Само значение объекта хранится по тому же пути, а подполя адресуются как
// [...path, ключ] — недостающий объект создаётся при записи (setAtPath).

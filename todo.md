...
публикуемые пакеты то есть ui и studio должны иметь бандлеры типа vite, чтобы публиковать на npm

для ui и studio нужно генерировать css файл и экспортировать его и просить людей вставить его себе в приложение

использовать tsup вместо esbuild потому что там встроенные dts

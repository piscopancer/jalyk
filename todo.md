...
! если нужно просто рендерить поле, нужно просто указать его id и id документа, так документ по айди будет найден в бд, прочитан его тип, по типу будет найдена схема документа а внутри схемы по пути поля будет найдена другая инфа нужная для поля типа shape

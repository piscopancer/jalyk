...
! вебсокет сервер и хттп сервер должны быть в одном месте, чтобы хттп запросы обновляли бд и просили вебсокет сервер отправить вебсокет клиентам сообщения об обновлении. это можно сделать так
...
! если нужно рендерить поле самостоятельно, нужно просто указать его id и id документа, так документ по айди будет найден в бд, прочитан его тип, по типу будет найдена схема документа а внутри схемы по пути поля будет найдена другая инфа нужная для поля типа shape
